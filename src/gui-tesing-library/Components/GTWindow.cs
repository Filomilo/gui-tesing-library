...
{
    private readonly GTWindow_CS _windowCS;
    ...
    public Vector2i Size => new(_windowCS.GetWindowSize());
    ...
    public Vector2i Position => new(_windowCS.GetPosition());

    public bool DoesExist => _windowCS.DoesExist();

    public string Name => _windowCS.GetWindowName();

    public bool IsMinimized => _windowCS.IsMinimized();
