...
public class SystemControllerTest
{
    ...
    public void GetClipBoardContentTest()
    {
        ...
        MouseController
            ...
            .ClickLeft();
        var loreIsum = TestHelpers.GetLoremIpsumText();
        KeyboardController
        ...
        var clipBoardContent = SystemController.Instance.GetClipBoardContent();
        Assert.That(
    ...
    public void FindProcessByNameTest()
    {
        ...
        IEnumerable<IGTProcess> process = SystemController.Instance.FindProcessByName("java.exe");
        Assert.That(
            process.Count() > 0,
    ...
    {
        var maximizedWindowSize = SystemController.Instance.GetMaximizedWindowSize();
        Assert.That(
    ...
    public void GetScreenSizeTest()
    {
        ...
        Assert.That(screenSize.x > 0 && screenSize.y > 0, "Screen size should be greater than 0.");
    }

    [Test]
    public void GetOSVersopn()
    {
        var osVersion = SystemController.Instance.GetOsVersion();
