...
#include "Vector2i.h"
class GtSystemController
{
private:
    std::shared_ptr<SystemCalls> _SystemCalls;
    static std::shared_ptr<GtSystemController> _gtSystem;
    GtSystemController();
public:

    static std::shared_ptr<GtSystemController> Instance();
